...
class setting(object):
    def __init__(self):
        ...
        """
        fit_type: (Default=='qp-sign_flipping') The type of fitting routine
        ...
        model_type: (Default = 'normalised_polynomial') The type of model used
            ...
            Accepted options:
                'normalised_polynomial' - This is a polynomial of the form
                    y=y_0*sum(p_i*(x/x_0)**i). It consistently appears to give
                    the best fit.
                'polynomial' - This is a polynomial of the form
                    y=sum(p_i*(x)**i).
                'MSF_2017_polynomial' - This is a polynomial of the form
                    described in section 4 of doi:10.3847/1538-4357/aa69bd.
        ...
        cvxopt_maxiter: (Default=1000) The maximum number of iterations for
            the cvxopt quadratic programming routine.

        filtering: (Default=True) Generally for high order N there will be
        ...
        ifp_list: (Default = 'None') The list of derivatives you wish to allow
