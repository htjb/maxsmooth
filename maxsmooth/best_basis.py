...
:math:`{N}` for the 7 built in models and saves the figure to the base directory.
"""
    ...
    **Kwargs:**
        ...
        **of integers**
            | The DCF orders to test each basis function with. In
                some instances the basis function may fail for a given :math:`{N}`
                and higher orders due to overflow/underflow errors or ``CVXOPT``
                errors.
    """
